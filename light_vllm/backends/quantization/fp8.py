...
from light_vllm.backends.fused_moe import FusedMoE, FusedMoEMethodBase
from light_vllm.backends.linear import (LinearBase, LinearMethodBase,
                                        UnquantizedLinearMethod)
from light_vllm.backends.quantization.base_config import (QuantizationConfig,
                                                          QuantizeMethodBase)
from light_vllm.backends.quantization.kv_cache import BaseKVCacheMethod
from light_vllm.backends.quantization.utils.marlin_utils_fp8 import (
    apply_fp8_marlin_linear, prepare_fp8_layer_for_marlin)
from light_vllm.backends.quantization.utils.quant_utils import is_layer_skipped
from light_vllm.backends.quantization.utils.w8a8_utils import (
...
class Fp8MoEMethod(FusedMoEMethodBase):
    ...
    def apply(self,
        ...
        from light_vllm.backends.fused_moe import fused_moe
        return fused_moe(x,
                         layer.w13_weight,
                         layer.w2_weight,
                         router_logits,
