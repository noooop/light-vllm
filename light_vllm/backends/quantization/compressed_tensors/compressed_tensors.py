...
from light_vllm.backends.quantization.base_config import (  # noqa: E501
...
from light_vllm.backends.quantization.compressed_tensors.utils import (
...
class CompressedTensorsConfig(QuantizationConfig):
    ...
    def from_config(cls, config: Dict[str, Any]) -> "CompressedTensorsConfig":
        ...
        # backends are impacted by the quantization details. The quantization
