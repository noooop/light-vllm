...
from light_vllm.backends.quantization.utils.quant_utils import (
...
def should_ignore_layer(layer_name: Optional[str],
    ...
    # layer_name = model.backends.0.self_attn.qkv_proj
    # proj_name = qkv_proj
    proj_name = layer_name.split(".")[-1]

    # Fused backends like gate_up_proj or qkv_proj will not be fused
    ...
    # Unfused backends like down_proj and o_proj will match
