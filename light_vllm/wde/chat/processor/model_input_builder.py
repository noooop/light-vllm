...
from light_vllm.wde.chat.config import (CacheConfig, ModelConfig,
                                        SchedulerConfig)
from light_vllm.wde.chat.processor.model_input_builder2 import (
    ModelInputForGPUBuilder)
from light_vllm.wde.chat.schema.execute_io import (
    ExecuteInput, ExecuteModelInput, ModelInput,
    ModelInputForGPUWithSamplingMetadata, WorkerInput)
...
class ChatModelPreProcessor(ModelInputBuilder):
    ...
    def prepare_worker_input(
            self, execute_model_input: ExecuteModelInput) -> WorkerInput:
    ...
    def __call__(self, scheduler_output: SchedulerOutput) -> ExecuteInput:
        ...
        worker_input: WorkerInput = self.prepare_worker_input(
            execute_model_input)
        model_input: ModelInput = self.prepare_model_input(
