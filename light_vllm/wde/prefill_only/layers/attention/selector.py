...
class AttnBackend:
    ...
    def get_backend_cls(backend):
        if backend == _Backend.FLASH_ATTN:
            ...
            from light_vllm.wde.prefill_only.layers.attention.backends.flash_attn import (  # noqa: E501
                PrefillOnlyFlashAttentionBackend)
            return PrefillOnlyFlashAttentionBackend
        if backend == _Backend.XFORMERS:
            logger.info("Using XFormers backend.")
            from light_vllm.wde.prefill_only.layers.attention.backends.xformers import (  # noqa: E501
                PrefillOnlyXFormersBackend)
            return PrefillOnlyXFormersBackend
        elif backend == _Backend.TORCH_SDPA:
            logger.info("Using Torch SDPA backend.")
            from light_vllm.wde.prefill_only.layers.attention.backends.torch_sdpa import (  # noqa: E501
            ...
            from light_vllm.wde.prefill_only.layers.attention.backends.flashinfer import (  # noqa: E501
            ...
            from light_vllm.wde.prefill_only.layers.attention.backends.torch_naive import (  # noqa: E501
