...
if HAS_TRITON:
    from light_vllm.layers.ops.sample import sample as sample_triton

from light_vllm.wde.decoding.layers.sampling_metadata import (
    SamplingMetadata, SamplingTensors, SequenceGroupToSample)
from light_vllm.wde.decoding.layers.sampling_params import SamplingType
from light_vllm.wde.decoding.schema.execute_io import (
    CompletionSequenceGroupOutput, SamplerOutput, SequenceOutput)
from light_vllm.wde.decoding.schema.sequence import (Logprob, PromptLogprobs,
                                                     SampleLogprobs)
