...
from light_vllm.wde.decoding.processor.utils.interfaces import (
    SequenceGroupOutputProcessor)
from light_vllm.wde.decoding.processor.utils.stop_checker import StopChecker
from light_vllm.wde.decoding.schema.execute_io import (SequenceGroupOutput,
                                                       SequenceOutput)
            ...
            for seq, parent in child_seqs:
                if seq is not parent:
                    ...
                    if not seq.is_finished():
                        seq_need_fork.append((parent, seq))
