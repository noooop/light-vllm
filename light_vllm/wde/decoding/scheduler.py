...
from light_vllm.wde.core.schema.engine_io import (Request, RequestOutput,
                                                  SchedulerOutput)
from light_vllm.wde.decoding.config import CacheConfig, SchedulerConfig
from light_vllm.wde.decoding.core.interfaces import (AllocStatus,
                                                     BlockSpaceManager)
from light_vllm.wde.decoding.schema.sequence import (Sequence, SequenceData,
                                                     SequenceGroup,
...
class Scheduler:
    ...
    def _schedule_prefills(
        ...
        It schedules waiting requests as long as it fits `budget`
