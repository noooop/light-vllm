...
@dataclass
class ChatSchedulerOutput(SchedulerOutput):
    scheduled_requests: Iterable[ChatRequest]

    def is_empty(self) -> bool:
        return not self.scheduled_requests


class ChatRequestOutput(RequestOutput):
    """
...
from light_vllm.wde.decoding.schema.sequence import (PromptLogprobs,
                                                     RequestMetrics,
                                                     SampleLogprobs,
                                                     SequenceGroup,
                                                     SequenceStatus)
