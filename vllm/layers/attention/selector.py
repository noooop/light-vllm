...
def get_attn_backend(
    ...
    if is_blocksparse:
        ...
        from vllm.layers.attention.backends.blocksparse_attn import (
    ...
    if backend == _Backend.FLASH_ATTN:
        from vllm.layers.attention.backends.flash_attn import (  # noqa: F401
            FlashAttentionBackend)
        return FlashAttentionBackend
    if backend == _Backend.XFORMERS:
        logger.info("Using XFormers backend.")
        from vllm.layers.attention.backends.xformers import (  # noqa: F401
            XFormersBackend)
