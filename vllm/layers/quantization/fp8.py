...
from vllm.layers.fused_moe import FusedMoE, FusedMoEMethodBase
from vllm.layers.linear import (LinearBase, LinearMethodBase,
                                               UnquantizedLinearMethod)
from vllm.layers.quantization.base_config import (
    QuantizationConfig, QuantizeMethodBase)
from vllm.layers.quantization.kv_cache import BaseKVCacheMethod
from vllm.layers.quantization.utils.marlin_utils_fp8 import (
    apply_fp8_marlin_linear, prepare_fp8_layer_for_marlin)
from vllm.layers.quantization.utils.quant_utils import (
    is_layer_skipped)
from vllm.layers.quantization.utils.w8a8_utils import (
...
class Fp8MoEMethod(FusedMoEMethodBase):
    ...
    def apply(self,
        ...
        from vllm.layers.fused_moe import fused_moe
        return fused_moe(x,
                         layer.w13_weight,
                         layer.w2_weight,
                         router_logits,
